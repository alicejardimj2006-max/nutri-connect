    ...
    <div className="grid gap-6 lg:grid-cols-[280px_1fr]">
      <Section title="Foto">
        <div className="flex flex-col items-center">
          ...
          <button className="mt-4 rounded-full border px-5 py-1.5 text-xs font-semibold hover:bg-muted shadow-lg">Alterar foto</button>
        </div>
      </Section>
      <Section title="Dados profissionais">
        ...
        <button onClick={() => toast.success("Perfil atualizado!")} className="mt-5 rounded-full bg-primary px-6 py-2.5 text-sm font-semibold text-primary-foreground shadow-lg hover:bg-primary/90">
          Editar perfil
        </button>
