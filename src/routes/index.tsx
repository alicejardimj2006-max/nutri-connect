        ...
        <section className="mx-auto max-w-7xl px-4 py-16">
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              <div key={c.title} className=" rounded-lg border p-6 shadow-sm transition hover:shadow-lg">
          ...
          <div className="mx-auto max-w-7xl px-4">
            ...
            <ol className="mt-10 grid gap-4 md:grid-cols-5">
              {[
                ...
                <li key={s.t} className=" transition hover:shadow-lg rounded-lg border bg-card p-5 text-center shadow-sm">
